...
class TDummyData {
  ...
  static final List<BrandModel> brands = [
    BrandModel(
      ...
      isFeatured: true,
      isVerified: true,
      description: 'Global performance retailer for shoes, sportswear and equipment.',
      contactEmail: 'support@nike.com',
      website: 'https://www.nike.com',
      city: 'Beaverton',
      state: 'Oregon',
      country: 'USA',
      socialLinks: {'Instagram': '@nike', 'X': '@Nike'},
    ),
    BrandModel(
      id: '2',
      ...
      isFeatured: true,
      isVerified: true,
      description: 'Retailer focused on lifestyle and performance sports collections.',
      website: 'https://www.adidas.com',
      city: 'Herzogenaurach',
      country: 'Germany',
      socialLinks: {'Instagram': '@adidas'},
    ),
